...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Jan 27 10:13:22 2016
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/GameRoom1.0.0/ && $(COPY_FILE) --parents games/game.h gamelist.h games/individual_game/tictactoe.h gamestate/individual_game_states/tictactoegamestate.h gamestate/gamestate.h debug/debugsandbox.h debug/unittests/testdirectory.h ai/algorithms/minimax.h debug/unittests/aialgorithm/aialgorithmtester.h ai/computer_players/computerplayer.h ai/computer_players/tictactoecomputerplayer.h debug/cli.h games/game_type/cardgame.h debug/unittests/gametests/checkerstests.h debug/unittests/gametests/tictactoetests.h gamestate/individual_game_states/checkersgamestate.h games/individual_game/checkers.h ai/computer_players/checkerscomputerplayer.h .tmp/GameRoom1.0.0/ && $(COPY_FILE) --parents main.cpp games/game.cpp gamelist.cpp games/individual_game/tictactoe.cpp gamestate/individual_game_states/tictactoegamestate.cpp gamestate/gamestate.cpp debug/debugsandbox.cpp debug/unittests/testdirectory.cpp ai/algorithms/minimax.cpp debug/unittests/aialgorithm/aialgorithmtester.cpp ai/computer_players/computerplayer.cpp ai/computer_players/tictactoecomputerplayer.cpp debug/cli.cpp debug/unittests/gametests/checkerstests.cpp debug/unittests/gametests/tictactoetests.cpp gamestate/individual_game_states/checkersgamestate.cpp games/individual_game/checkers.cpp ai/computer_players/checkerscomputerplayer.cpp .tmp/GameRoom1.0.0/ && (cd `dirname .tmp/GameRoom1.0.0` && $(TAR) GameRoom1.0.0.tar GameRoom1.0.0 && $(COMPRESS) GameRoom1.0.0.tar) && $(MOVE) `dirname .tmp/GameRoom1.0.0`/GameRoom1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/GameRoom1.0.0
