 ...
 * The string representation of a move are four numbers with the first being the x coordinate, and the second being the y coordinate for the starting and ending square
 */
